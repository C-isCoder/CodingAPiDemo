package demo.codingapi.android.printer;
...
public class PrinterActivity extends Activity {
    ...
    public void print(View view) {
        ...
        intent.putExtra(PrinterService.PRINT_DATA, PrinterFormat.getPrintData());
        // 启动服务 自动打印。
        startService(intent);
    }
    ...
    private BroadcastReceiver mPrinterReceiver = new BroadcastReceiver() {
        @Override public void onReceive(Context context, Intent intent) {
            PrinterService.STATUS status = (PrinterService.STATUS) intent.getSerializableExtra(
              PrinterService.FILTER_ACTION);
            String errorMsg = "";
